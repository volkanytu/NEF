...
namespace NEF.Web.Documents
{
    ...
    /// </summary>
    public partial class preSalesForm : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Guid quoteId = Guid.Parse(this.Request.QueryString["Id"]);

            string fileName = new PreSalesFormHelper().ExecutePreSalesForm(quoteId, this.Server.MapPath("/"));
            ...
            if (fileName != string.Empty)
            {
                ...
                if (fileInfo.Exists)
                {
                    ...
                    //    Response.Clear();
                    //    Response.AppendHeader("Content-Disposition", "attachment;filename*=UTF-8''" + Uri.EscapeDataString("Ön Bilgilendirme Formu.pdf"));
                    ...
                    this.Response.AppendHeader("Content-Disposition", "attachment;filename*=UTF-8''" + Uri.EscapeDataString("Ön Bilgilendirme Formu.docx"));
