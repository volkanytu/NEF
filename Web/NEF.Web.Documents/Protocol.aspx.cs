...
namespace NEF.Web.Documents
{
    public partial class Protocol : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string fileName = new ProtocolHelper().ExecuteDocumentWritenRecordForm(productId, this.Server.MapPath("/"));
            ...
            if (fileName != string.Empty)
            {
                ...
                if (fileInfo.Exists)
                {
                    ...
                    this.Response.AppendHeader("Content-Disposition", "attachment;filename*=UTF-8''" + Uri.EscapeDataString("EK PROTOKOL VE MUVAFAKATNAME.docx"));
