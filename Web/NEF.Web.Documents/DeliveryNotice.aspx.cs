...
{
    public partial class DeliveryNotice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Guid productId = Guid.Parse(this.Request.QueryString["Id"]);

            string fileName = new DeliveryNoticeHelper().ExecuteDocumentWritenRecordForm(productId, this.Server.MapPath("/"));
            ...
            if (fileName != string.Empty)
            {
                ...
                if (fileInfo.Exists)
                {
                    ...
                    this.Response.AppendHeader("Content-Disposition", "attachment;filename*=UTF-8''" + Uri.EscapeDataString("Teslim Tesellüm.docx"));
