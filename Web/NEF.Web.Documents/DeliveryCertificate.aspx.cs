...
namespace NEF.Web.Documents
{
    public partial class DeliveryCertificate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string fileName = new DeliveryCertificateHelper().ExecuteDocumentWritenRecordForm(productId, this.Server.MapPath("/"));
            ...
            if (fileName != string.Empty)
            {
                ...
                if (fileInfo.Exists)
                {
                    ...
                    this.Response.AppendHeader("Content-Disposition", "attachment;filename*=UTF-8''" + Uri.EscapeDataString("Teslim Tutanağı BTE.docx"));
