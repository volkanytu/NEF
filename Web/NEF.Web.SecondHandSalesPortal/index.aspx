<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="NEF.Web.SecondHandSalesPortal.index" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>NEF İkinci El Satış Portalı</title>
    ...
    <link href="global/plugins/bootstrap-toastr/toastr.css" rel="stylesheet" />
...
<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed page-sidebar-closed" runat="server" id="bdy">
    <input type="hidden" value="" id="lblUserId" runat="server" />
    <input type="hidden" value="" id="lblUserType" runat="server" />
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <h1 style="color: white; font-size: larger"><b>NEF</b> İkinci El Satış </h1>
            </div>
            <!-- END LOGO -->
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <i class="icon-bell"></i>
                            <span class="badge badge-default" id="lblFeedCount" style="display: none;"></span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" id="lstFeeds" style="height: 250px;">
                                    <%--                                    <li>
                                        <a href="#">
                                            <span class="label label-sm label-icon label-success">
                                                <i class="fa fa-plus"></i>
                                            </span>
                                            Volkan Serter ile bir randevu oluşturuldu. <span class="time">5 dk.
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            ...
                                            Kemal Burak Yılmaz ile bir randevu oluşturuldu. <span class="time">15 dk.
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            ...
                                            Burçak Çağlar ile bir randevu oluşturuldu. <span class="time">25 dk.
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            ...
                                            Mert Oskay ile bir randevu oluşturuldu. <span class="time">35 dk.
                                            </span>
                                        </a>
                                    </li>--%>
                                </ul>
                            ...
                            <%-- <li class="external">
                                <a href="#">Tüm bildirimleri gör <i class="m-icon-swapright"></i>
                                </a>
                            </li>--%>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="images/volkanprofileB.jpg" id="imgProfile" />
                            <span class="username" id="lblUserName">---
                            </span>
                        ...
                        <!--<ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="page_calendar.html">
                                    <i class="icon-calendar"></i> Takvimim
                                </a>
                            </li>
                            <li>
                                <a href="inbox.html">
                                    <i class="icon-envelope-open"></i> Mesajlarım <span class="badge badge-danger">
                                        3
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="icon-rocket"></i> Görevlerim <span class="badge badge-success">
                                        7
                                    </span>
                                </a>
                            </li>
                    ...
                    <!--<li class="dropdown">
                        <a href="javascript:document.location.href='locked.html';" class="dropdown-toggle">
    ...
    <div class="page-container">
        ...
        <div class="page-sidebar-wrapper">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu page-sidebar-menu-closed" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li class="start active open" id="liHome">
                        <a href="#" id="btnHome">
                    ...
                    <%--   <li id="liAllChart">
                        <a href="#" id="btnAllChart">
                            <i class="icon-pie-chart"></i>
                            <span class="title">Tüm Ekip Panosu</span>
                        </a>
                    </li>--%>
                    <li id="liSearch">
                        <a href="#" id="btnSearch">
                            <i class="icon-magnifier"></i>
                            <span class="title">Müşteri Arama</span>
                        </a>
                    </li>
                    <li class="last" id="liHouseSearch">
                        <a href="#" id="btnHouseSearch">
                            <i class="icon-home"></i>
                            <span class="title">Konut Arama</span>
                        </a>
                    </li>
                    <li class="last" id="liAuthorityDocs">
                        <a href="#" id="btnAuthorityDocs">
                            <i class="icon-folder"></i>
                            <span class="title">Yetki Dokumanları</span>
                        </a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <iframe src="" id="ifrmContent" style="width: 100% !important; border: none; padding-left: 0px !important; padding-right: 0px !important;" scrolling="no"></iframe>
                    </div>
                </div>
                                    ...
                                    <li>
                                        <div class="col1">
                                            <div class="cont">
                                                ...
                                                <div class="cont-col2">
                                                    <div class="desc">
                                                        New order received with <span class="label label-sm label-success">Reference Number: DR23923
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="col1">
                                            <div class="cont">
                                                ...
                                                <div class="cont-col2">
                                                    <div class="desc">
                                                        Web server hardware needs to be upgraded. <span class="label label-sm label-warning">Overdue
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="col1">
                                            <div class="cont">
                                                ...
                                                <div class="cont-col2">
                                                    <div class="desc">
                                                        Web server hardware needs to be upgraded. <span class="label label-sm label-default ">Overdue
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="page-footer">
        <div class="page-footer-inner">
            2015 &copy; Nef Satış Portalı by Innthebox
        </div>
    ...
    <script src="global/plugins/bootstrap-toastr/toastr.js"></script>
