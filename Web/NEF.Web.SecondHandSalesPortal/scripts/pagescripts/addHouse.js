...
var AddActivityIntrestedHouseHelper = {
    ...
    "Search": function (product, callbackFunction) {
        ...
        product.RentalMonths = product.RentalMonths == "" ? null : product.RentalMonths;
        product.GoodsStatus = product.GoodsStatus == "" ? null : product.GoodsStatus;
        ...
        $.ajax({
            url: CustomServiceUrl + "/MakeRentalHouseSearchForActivity",
            async: true,
            dataType: "json",
            data: jSonData,
            contentType: "application/json;",
...
function mainController($scope) {
    ...
    $scope.Create = function () {
        ...
        if (AddActivityIntrestedHouseHelper.PhoneCallId != null) {
            frameProperties = "<iframe src='addrenthousetoactivity.html?projectid=F3C2C130-405E-E611-80FF-005056A60603&ActivityType=1&ActivityId=" + AddActivityIntrestedHouseHelper.PhoneCallId + "' style='width:100% !important; border:none;height:450px;padding-left:0px !important;padding-right:0px !important;overflow-y:scroll !important;overflow-x: hidden !important;' scrolling='auto' id=\"rentframe\"></iframe>";
        } else if (AddActivityIntrestedHouseHelper.AppointmentId != null) {
            frameProperties = "<iframe src='addrenthousetoactivity.html?projectid=F3C2C130-405E-E611-80FF-005056A60603&ActivityType=2&ActivityId=" + AddActivityIntrestedHouseHelper.AppointmentId + "' style='width:100% !important; border:none;height:450px;padding-left:0px !important;padding-right:0px !important;overflow-y:scroll !important;overflow-x: hidden !important;' scrolling='auto' id=\"rentframe\"></iframe>";
        }
        parent.IndexHelper.ShowDialog(frameProperties, "", "modal90");
    }
