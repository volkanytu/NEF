<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="NEF.Web.SalesPortal.index" %>
...
<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed page-sidebar-closed" runat="server" id="bdy">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner">
            ...
            <div class="page-logo">
                <a href="index.aspx">
                    <img src="admin/layout/img/nef_logo_white.png" alt="logo" class="logo-default" />
                </a>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <i class="icon-bell"></i>
                            <span class="badge badge-default" id="lblFeedCount" style="display:none;">
                            </span>
                        </a>
        ...
        <div class="page-sidebar-wrapper">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu page-sidebar-menu-closed" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li class="last" id="liCallCenter">
                        <a href="#" id="btnCallCenter">
