...
function mainController($scope) {
    ...
    $scope.openDetail = function (id, type) {
        ...
        if (parent.IndexHelper.UserType != UserTypes.CallCenter) //Resepsiyonistler arama sayfası dışında herhangi bir sayfaya gidemez.
        {
                ...
                ContactSearchHelper.CustomerHasCallCenterCall(id, function (e) {
                    $scope.$apply(function () {
                        if (e.Success) {
                            ...
                            //Kemal Burak Yılmaz
                            //08.04.2015
                            //Nef tarafının isteği doğrusunda kaldırıldı.

                            //ContactSearchHelper.CreateActivityForCallCenter(id, type, function (createResult) {
                            //    if (createResult.Success) {
                            //        if (type == EntityTypes.Kisi) {
                            //            $("#ifrmContent", parent.document).attr("src", "editcontact.html?contactid=" + id + "&phonecallid=" + createResult.CrmId).css("height", "3500px");
                            //        }
                            //        else {
                            //            $("#ifrmContent", parent.document).attr("src", "editaccount.html?accountid=" + id + "&phonecallid=" + createResult.CrmId).css("height", "3500px");
                            //        }
                            //    }
                            //    else {
